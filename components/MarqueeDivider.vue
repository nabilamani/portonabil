...
const props = defineProps({
  text: {
    type: String,
    default: 'MUHAMMAD NABIL AMANI • PROMPT ENGINEER • CREATIVE DESIGNER • AVAILABLE FOR HIRE • MUHAMMAD NABIL AMANI • PROMPT ENGINEER • CREATIVE DESIGNER • AVAILABLE FOR HIRE •'
  },
  color1: {
    type: String,
