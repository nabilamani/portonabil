...
const props = defineProps({
  text: {
    type: String,
    default: 'MUHAMMAD NABIL AMANI • PECUT ENGINEER • CREATIVE DESIGNER • AVAILABLE FOR HIRE • MUHAMMAD NABIL AMANI • PECUT ENGINEER • CREATIVE DESIGNER • AVAILABLE FOR HIRE •'
  },
  color1: {
    type: String,
