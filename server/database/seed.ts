...
async function seed() {
    ...
    try {
        ...
        await db.insert(s.profile).values({
            ...
            bio: "Menguasai pengembangan REST API menggunakan Laravel dan integrasinya dengan aplikasi mobile berbasis Flutter, serta mampu mengelola dan mengoptimasi basis data menggunakan MySQL dan layanan Firebase. Berpengalaman dalam membangun sistem informasi, aplikasi manajemen data, company profile, hingga aplikasi mobile terintegrasi, serta dapat mengembangkan arsitektur web monolith maupun microservices sesuai kebutuhan proyek. Menguasai pengembangan REST API menggunakan Laravel dan integrasinya dengan aplikasi mobile berbasis Flutter, serta mampu mengelola dan mengoptimasi basis data menggunakan MySQL dan layanan Firebase. Berpengalaman dalam membangun sistem informasi, aplikasi manajemen data, company profile, hingga aplikasi mobile terintegrasi, serta dapat mengembangkan arsitektur web monolith maupun microservices sesuai kebutuhan proyek. Selain itu, memiliki ketertarikan sebagai videography enthusiast, khususnya dalam pengambilan footage video drone untuk menghasilkan konten visual yang sinematik dan informatif.",
